...
use Modules\AdvertisementModule\Services\AdvertisementService;
...
class AdvertisementController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('advertisementmodule::dashboard.advertisements.index',compact('advertisements'));
    }
    ...
    {
        return view('advertisementmodule::dashboard.advertisements.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('advertisementmodule::dashboard.advertisements.edit',compact('advertisement'));
    }
